        ...
        >
          <div className="flex flex-wrap gap-1 items-center">
            {selected.map((option) => {
              return (
                ...
                >
                  ...
                  <button
                    className={cn(
                      "mx-1 rounded-full outline-none ring-offset-background focus:ring-2 focus:ring-ring focus:ring-offset-2",
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                "ml-1 flex-1 bg-transparent outline-none placeholder:text-muted-foreground focus-visible:shadow-none focus-visible:ring-0 focus-visible:ring-offset-0 border border-transparent",
