...
Our main service is the [WATcloud compute cluster](/docs/compute-cluster/overview) (sometimes referred to as "the compute cluster" or "WATcloud"),
...
<Cards num={3}>
  <Cards.Card image arrow title="Getting Access" href="/docs/compute-cluster/getting-access">
    <span className="hidden dark:block"><Picture alt="Abstract Computer (Dark)" srcs={["avif","generated.webp","generated.jpg"].map(f => `${websiteConfig.base_path}/assets/computer-dark.${f}`)} /></span>
    <span className="dark:hidden"><Picture alt="Abstract Computer (Light)" srcs={["avif","generated.webp","generated.jpg"].map(f => `${websiteConfig.base_path}/assets/computer-light.${f}`)} /></span>
  </Cards.Card>
  <Cards.Card image arrow title="View Specs" href="/machines">
    <span className="hidden dark:block"><Picture alt="Robot with GPU (Dark)" srcs={["avif","generated.webp","generated.jpg"].map(f => `${websiteConfig.base_path}/assets/robot-dark.${f}`)} /></span>
    <span className="dark:hidden"><Picture alt="Robot with GPU (Light)" srcs={["avif","generated.webp","generated.jpg"].map(f => `${websiteConfig.base_path}/assets/robot-light.${f}`)} /></span>
  </Cards.Card>
  <Cards.Card image arrow title="Get Involved" href="/get-involved">
    <span className="hidden dark:block"><Picture alt="Constructing the Cloud (Dark)" srcs={["avif","generated.webp","generated.jpg"].map(f => `${websiteConfig.base_path}/assets/cloud-dark.${f}`)} /></span>
    <span className="dark:hidden"><Picture alt="Constructing the Cloud (Light)" srcs={["avif","generated.webp","generated.jpg"].map(f => `${websiteConfig.base_path}/assets/cloud-light.${f}`)} /></span>
  </Cards.Card>
</Cards>
